        ...
        <a href="#" class="nav-link pr-0" @click.prevent slot="title-container">
          <b-media no-body class="align-items-center">
            ...
            <b-media-body class="ml-2 d-none d-lg-block">
              <span class="mb-0 text-sm  font-weight-bold">{{login_name}} {{login_lastname}}</span>
            </b-media-body>
          </b-media>
        </a>
...
export default {
  ...
  methods: {
    ...
    basicService.getProfile().then((response)=>{
      console.log(response);
      this.login_name = response.data.first_name;
      this.login_lastname = response.data.last_name
    })
  }
};
</script>
